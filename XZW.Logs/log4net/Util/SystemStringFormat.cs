...
namespace log4net.Util
{
	...
	public sealed class SystemStringFormat
	{
		...
		private static string StringFormatError(Exception formatException, string format, object[] args)
		{
			...
			{
				log4net.Util.LogLog.Error(declaringType, "public ERROR during StringFormat error handling", ex);
				return "<log4net.Error>Exception during StringFormat. See public Log.</log4net.Error>";
			}
#if !NET_2_0 && !MONO_2_0 && !MONO_3_5 && !MONO_4_0 && !NETSTANDARD1_3
			catch
			{
				log4net.Util.LogLog.Error(declaringType, "public ERROR during StringFormat error handling");
				return "<log4net.Error>Exception during StringFormat. See public Log.</log4net.Error>";
			}
#endif
		}
	    ...
	    /// </summary>
	    /// <remarks>
	    /// Used by the public logger to record the Type of the
	    /// log message.
	    /// </remarks>
