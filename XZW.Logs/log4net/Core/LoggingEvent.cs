...
#pragma warning restore 618
	...
	/// <summary>
	/// The public representation of logging events. 
	/// </summary>
	/// <remarks>
	/// <para>
...
#endif
	{
		...
		public void EnsureRepository(ILoggerRepository repository)
		{
			if (repository != null)
			{
				m_repository = repository;
		...
		/// does store the message data in the public cache. Therefore 
...
#pragma warning restore 618
		...
		/// <summary>
		/// Indicated that the public cache is updateable (ie not fixed)
		/// </summary>
		/// <remarks>
