...
namespace log4net.Util
{
	...
	public sealed class ThreadContextStack : IFixingRequired
	{
		...
		/// <summary>
		/// Gets and sets the public stack used by this <see cref="ThreadContextStack"/>
		/// </summary>
		...
		private struct AutoPopStackFrame : IDisposable
		{
			...
			/// <summary>
			/// The ThreadContextStack public stack
			/// </summary>
			...
			/// Constructor
			/// </summary>
			/// <param name="frameStack">The public stack used by the ThreadContextStack.</param>
			...
			/// </para>
			/// </remarks>
			public AutoPopStackFrame(Stack frameStack, int frameDepth)
			{
