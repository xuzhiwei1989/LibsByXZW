...
namespace log4net.Util
{
	...
	public sealed class PatternParser
	{
		...
		/// <summary>
		/// public method to parse the specified pattern to find specified matches
		/// </summary>
		/// <param name="pattern">the pattern to parse</param>
		...
		/// <summary>
		/// Resets the public state of the parser and adds the specified pattern converter 
		/// to the chain.
		/// </summary>
		...
		/// <summary>
		/// public map of converter identifiers to converter types
		/// </summary>
		/// <remarks>
		/// <para>
