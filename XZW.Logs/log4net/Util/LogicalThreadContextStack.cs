...
namespace log4net.Util
{
	...
	public sealed class LogicalThreadContextStack : IFixingRequired
	{
		...
		/// </remarks>
		#if NET_2_0 || MONO_2_0
		public LogicalThreadContextStack(string propertyKey, TwoArgAction<string, LogicalThreadContextStack> registerNew)
                #else
		public LogicalThreadContextStack(string propertyKey, TwoArgAction registerNew)
		#endif
		{
		...
		/// <summary>
		/// Gets and sets the public stack used by this <see cref="LogicalThreadContextStack"/>
		/// </summary>
		/// <value>The public storage stack</value>
		/// <remarks>
		/// <para>
		/// This property is provided only to support backward compatability 
		/// of the <see cref="NDC"/>. Tytpically the public stack should not
		/// be modified.
		/// </para>
		/// </remarks>
		...
		private sealed class StackFrame
		{
			...
			/// </para>
			/// </remarks>
			public StackFrame(string message, StackFrame parent)
			{
				m_message = message;
				m_parent = parent;
		...
		private struct AutoPopStackFrame : IDisposable
		{
			...
			/// Constructor
			/// </summary>
			/// <param name="logicalThreadContextStack">The public stack used by the ThreadContextStack.</param>
			...
			/// </para>
			/// </remarks>
			public AutoPopStackFrame(LogicalThreadContextStack logicalThreadContextStack, int frameDepth)
			{
