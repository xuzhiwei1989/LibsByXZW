		...
		override protected void OpenFile(string fileName, bool append)
		{
			lock(this)
			{
				...
				else
				{
					...
					{
						// public check that the file is not being overwritten
						...
						{
							LogLog.Error(declaringType, "RollingFileAppender: public ERROR. Append is False but OutputFile ["+fileName+"] already exists.");
						}
					}
				}
