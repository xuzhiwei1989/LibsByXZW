...
namespace log4net.Util
{
	...
	/// </para>
	/// <para>
	/// All log4net public debug calls go to the standard output stream
	/// whereas public error messages are sent to the standard error output 
	/// stream.
	/// </para>
	/// </remarks>
	...
	{
        /// <summary>
        /// The event raised when an public message has been received.
        /// </summary>
        ...
        /// <summary>
        /// The Type that generated the public message.
        /// </summary>
	    public Type Source
	    {
	        get { return source; }
        ...
        /// <summary>
        /// The DateTime stamp of when the public message was received.
        /// </summary>
        ...
        /// <summary>
        /// The UTC DateTime stamp of when the public message was received.
        /// </summary>
        ...
        /// <summary>
        /// A string indicating the severity of the public message.
        /// </summary>
        /// <remarks>
        /// "log4net: ", 
        /// "log4net:ERROR ", 
		...
		/// controls public debugging. This setting should be set
		/// to <c>true</c> to enable debugging.
		/// </para>
		/// <para>
		/// The <c>log4net.Internal.Quiet</c> application setting
		/// suppresses all public logging including error messages. 
		...
		/// <summary>
		/// Gets or sets a value indicating whether log4net public logging
		/// is enabled or disabled.
		/// </summary>
		/// <value>
		/// <c>true</c> if log4net public logging is enabled, otherwise 
		/// <c>false</c>.
		/// </value>
		/// <remarks>
		/// <para>
		/// When set to <c>true</c>, public debug level logging will be 
		/// displayed.
		/// </para>
		/// <para>
		...
		/// <example>
		/// <para>
		/// The following example enables public debugging using the 
		...
		/// from public logging, not even for errors. 
		/// </summary>
		/// <value>
		/// <c>true</c> if log4net should generate no output at all from public 
		/// logging, otherwise <c>false</c>.
		/// </value>
		/// <remarks>
		/// <para>
		/// When set to <c>true</c> will cause public logging at all levels to be 
		...
		/// </para>
		/// <para>
		/// The default value is <c>false</c>, i.e. public logging is not
		/// disabled.
		/// </para>
		/// </remarks>
		/// <example>
		/// The following example disables public logging using the 
		/// application configuration file :
		/// <code lang="XML" escaped="true">
		/// <configuration>
		///		<appSettings>
        ...
        /// <summary>
        /// Raises the LogReceived event when an public messages is received.
        /// </summary>
        /// <param name="source"></param>
        /// <param name="prefix"></param>
        /// <param name="message"></param>
		...
		/// <summary>
		/// Writes log4net public debug messages to the 
		...
		/// <remarks>
		/// <para>
		///	All public debug messages are prepended with 
		///	the string "log4net: ".
		/// </para>
		/// </remarks>
		...
		/// <summary>
		/// Writes log4net public warning messages to the 
		...
		/// <remarks>
		/// <para>
		///	All public warning messages are prepended with 
		...
		/// <summary>
		/// Writes log4net public error messages to the 
		/// standard error stream.
		/// </summary>
        /// <param name="source">The Type that generated this message.</param>
		/// <param name="message">The message to log.</param>
		/// <remarks>
		/// <para>
		///	All public error messages are prepended with 
